...
import config.ConfigPartMain2_withXml;
...
public class MainForConfigPartMainAndXml {
	private static ApplicationContext appctx = null;

	public static void main(String[] args) throws IOException {
		
		appctx = new AnnotationConfigApplicationContext(ConfigPartMain2_withXml.class);
		// 다른 config 파일을 import한 class 하나만 작성해주면 됨
